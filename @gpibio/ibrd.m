...
%read. 
    ...
    ibsta = calllib('gpib32', 'ibrd', gpib.ud, gpib.buffer, cnt);
    gpib.ibsta = calllib('gpib32', 'ThreadIbsta');
    gpib.iberr = calllib('gpib32', 'ThreadIberr');
    gpib.ibcnt = calllib('gpib32', 'ThreadIbcnt');
    ibsta = gpib.ibsta;
